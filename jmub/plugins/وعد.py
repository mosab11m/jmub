...
async def _(event):
    ...
    channel_entity = await jmub.get_entity("@Ss0Bot")
    await jmub.send_message("@Ss0Bot", "/start")
    await asyncio.sleep(5)
    msg0 = await jmub.get_messages("@Ss0Bot", limit=1)
    await msg0[0].click(2)
    await asyncio.sleep(5)
    msg1 = await jmub.get_messages("@Ss0Bot", limit=1)
    ...
    for i in range(100):
        ...
        try:
            ...
            msg2 = await jmub.get_messages("@Ss0Bot", limit=1)
